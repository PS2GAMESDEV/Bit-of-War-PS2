...
function SkelbowEnemy(options) {
    this.scale = GAME_SCALE
    this.spritesheet = Assets.image(ASSETS_PATH.ENEMIES + "/enSkelbow.png");
...
SkelbowEnemy.prototype._initAnimations = function () {
...
SkelbowEnemy.prototype.draw = function (cameraX, cameraY) {
