...
function MinotaurEnemy(options) {
    this.scale = GAME_SCALE
    this.spritesheet = Assets.image(ASSETS_PATH.ENEMIES + "/enMinotaur.png");
...
MinotaurEnemy.prototype._initAnimations = function () {
...
MinotaurEnemy.prototype.draw = function (cameraX, cameraY) {
